...
*   **排期状态细化与归因推断**：废弃简单的二元展示，将项目按排班满足率细分为“已排满”、“部分排上”、“排不上”三个列表。同时新增智能启发式归因，系统会在“排不上项目”后标注推测原因，极大降低了人工对齐资源的时间成本。当项目管理页的关键属性（排期策略、团队归属等）发生变更时，陈旧的排期推测原因会被自动清空，保证大盘信息不过期。
